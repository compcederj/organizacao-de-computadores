...
Repositório de provas antigas da Disciplina **Organização de Computadores** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/organizacao-de-computadores.git`
...
`git clone git@github.com:compcederj/organizacao-de-computadores.git`
...
# Organização de Computadores
Repositório de provas antingas da Disciplina **Organização de Computadores** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
